                ...
                {(() => {
                  ...
                  return (
                    <View style={styles.analysisPanel}>
                      ...
                      <Text style={styles.marketHint}>{prediction.projectedTotal !== undefined ? "Score, margin, and total are generated by Field IQ regression models and remain estimates, not guarantees." : "Run the v3 ML pipeline to generate score, margin, and total projections."}</Text>
                    </View>
                  );
                })()}
              </View>
